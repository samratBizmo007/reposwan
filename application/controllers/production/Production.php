...
//echo '';
            ...
            . '<input type="number" min="0" id="po_prod_qty" name="po_prod_qty" class="form-control" value="' . $result[$i]['quantity'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Shared Qty</label>'
            . '<input type="number" min="0" id="po_shared_qty" name="po_shared_qty" class="form-control" value="' . $result[$i]['shared_product_quantity'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Produced Qty</label>'
            . '<input type="number" min="0" id="produced_qty" name="produced_qty" onkeyup="getProductionCalculation();" class="form-control" value="' . $result[$i]['produced_qty'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Rejected Qty</label>'
            . '<input type="number" min="0" id="rejected_qty" name="rejected_qty" onkeyup="getRejectedCalculation();" class="form-control" value="' . $result[$i]['rejected_qty'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Inprocess Qty</label>'
            . '<input type="number" min="0" id="inprocess_qty" name="inprocess_qty" readonly class="form-control" value="' . $result[$i]['inprocess_qty'] . '">'
