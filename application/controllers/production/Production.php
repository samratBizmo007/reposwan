...
//echo '';
            ...
            . '<input type="text" id="produced_qty" name="produced_qty" onkeyup="getProductionCalculation();" class="form-control" value="' . $result[$i]['produced_qty'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Rejected Qty</label>'
            . '<input type="text" id="rejected_qty" name="rejected_qty" onkeyup="getRejectedCalculation();" class="form-control" value="' . $result[$i]['rejected_qty'] . '">'
            . '</div>'
            . '<div class="col-lg-2 col-xs-12 col-sm-12">'
            . '<label>Inprocess Qty</label>'
            . '<input type="text" id="inprocess_qty" name="inprocess_qty" readonly class="form-control" value="' . $result[$i]['inprocess_qty'] . '">'
