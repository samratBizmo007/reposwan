        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="page_title">
                ...
                <form id="addProduct" ng-app="addProductForm" ng-cloak ng-controller="ProdCtrl">
                                ...
                                <div class="w3-col l12 w3-padding-top" >              
                                    <div class="col-md-4 col-sm-12 col-xs-12 w3-margin-bottom">
                                        <div class="form-group">
                                            ...
                                            <select name="rm_type" class="form-control w3-small" id="rm_type_{{$index}}" ng-change="RmType($index)" ng-model="rmtypeSelected">
                                    ...
                                    <div class="col-md-4 col-sm-12 col-xs-12 w3-margin-bottom">
                                        <div class="form-group">
                                            ...
                                            <input type="text" ng-model="rmgradeSelected" class="form-control" id="rm_grade_{{$index}}" name="rm_grade[]" placeholder="Enter Material Grade eg.CR, etc.">
                                        </div>
                                    </div>                          
                                </div>
                                <div class="w3-col l12" ng-show="rmSpecimen">
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-6 w3-margin-bottom">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" ng-model="rmweightSelected" class="form-control" id="rm_weight_{{$index}}" name="rm_weight[]" placeholder="Material Weight">
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6 col-xs-6 w3-margin-bottom">
                                        <div class="form-group">
                    ...
                    <!-- div for add more -->
                    <div class="w3-col l12">
                        <a class="btn w3-text-red w3-margin-top w3-right" id="addMore" style="padding:0;" ng-click="addNewProductSpecificationDiv()"><i class="fa fa-plus"></i> Add more</a>                     
                        <!--this is add more button ends here-->
                    </div>
                    <fieldset>
